'''
	865 Final Project
	Ravi and Srikanth
	The below code is borrowed from http://www.pygame.org/project-ChessBoard-282-.html
	We have added the predictive score in ChessBoard and ChessClient module.
	The ChessClient module calls the ChessBoard functions.
	1. ChessClient now initializes chess Board with a pattern
	2. ChessClient calls the predictMove function here, which is written by us in chessboard module
...
def main():
    ...
    g.pattern = input("Enter A Pattern No.")
    g.mainLoop()
